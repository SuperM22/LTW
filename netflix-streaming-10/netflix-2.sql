...
--
-- Host: 127.0.0.1
-- Creato il: Mag 21, 2021 alle 23:19
...
(6, 'Cosmic Sin', '00:02:34', 'azione', 'Un gruppo di guerrieri e scenziati collaborano per cercare di proteggere l\'umanità da un invasione aliena.', 2021, '00:00:00', './Media/Cosmic', './images/film/Cosmic.jpg'),
(7, 'Mad Max: Fury Road', '00:02:20', 'azione', 'Australia, in un futuro distopico post apocalittico in cui benzina ed acqua sono le risorse più rare e preziose. Tra le infinite dune di sabbia dove tutti lottano per sopravvivere, Max, solitario ex poliziotto ossessionato dalla perdita della famiglia, viene catturato dai Figli della Guerra, un’armata di soldati comandati dal signore della guerra, Immortan Joe, che grazie ai suoi possedimenti controlla la comunità.', 2015, '00:00:00', './Media/Mad.mp4', './images/film/Mad.jpg'),
(8, '007 Skyfall', '00:02:29', 'azione', 'In seguito al fallimento di una missione recente, Il celebre agente segreto britannico è costretto ad essere testimone di una serie terribile di eventi: la MI6 deve trasferirsi al più presto mentre i dipendenti sotto copertura vedono le proprie identità venire rivelate. M è disperata e si rivolge a James Bond in cerca di un aiuto immediato.', 2012, '00:00:00', './Media/007.mp4', './images/film/007.jpg'),
(9, 'Bridman', '00:02:35', 'commedia', 'L\'ex stella del cinema Riggan Thomson è occupato ad allestire un\'ambizioso spettacolo teatrale per Broadway e spera che la nuova produzione possa ravvivare la sua stagnante carriera. Il lavoro si rivela essere particolarmente difficile ma l\'uomo desidera provare ai critici di essere un vero artista e non soltanto un attore capace di ruoli secondari.', 2014, '00:00:00', './Media/Birdman', './images/film/Bird.jpg'),
...
(11, 'Yes Man', '00:02:30', 'commedia', 'Un uomo che dice sempre di no aderisce a un programma basato sul semplice impegno di dire sì a tutto. Da quel momento la sua vita cambia in maniera inaspettata.', 2008, '00:00:00', './Media/Yes.mp4', './images/film/Yes.jpg'),
(12, 'Non è un paese per vecchi', '00:04:54', 'crime', 'Durante una battuta di caccia in solitaria, un saldatore del Texas trova e si impossessa di una somma di denaro precedentemente rubata. L\'uomo diventa così preda di una banda di criminali.', 2007, '00:00:00', './Media/Non.mp4', './images/film/Non.jpg'),
...
(15, 'Arrival', '00:02:34', 'fantascienza', 'Alcune misteriose astronavi aliene arrivano sulla Terra: una linguista viene contattata dall\'esercito per determinare se gli extraterrestri hanno intenzioni pacifiche o se rappresentano invece una minaccia per l\'umanità.', 2016, '00:01:54', './Media/Arrival.mp4', './images/film/Arrival.jpg'),
(16, 'Avatar', '00:03:25', 'fantascienza', 'L\'ex marine Jake Sully è stato reclutato per una missione sul pianeta Pandora con lo scopo di recuperare risorse naturali in esaurimento sulla Terra. Inaspettatamente si ritrova a voler proteggere il mondo magico al quale si sente stranamente legato.', 2009, '00:00:00', './Media/Avatar.mp4', './images/film/Avatar.jpg'),
(17, 'Ex Machina', '00:03:13', 'fantascienza', 'Caleb, giovane programmatore della più grande compagnia di internet al mondo, vince un concorso per trascorrere una settimana nel rifugio di montagna di proprietà del CEO della società. Presto Caleb scopre di dover prendere parte a uno strano ed affascinante esperimento.', 2015, '00:00:00', './Media/Ex.mp4', './images/film/Ex.jpg'),
...
(21, 'Looper', '00:01:15', 'fantascienza', 'Anno 2074. Grazie all\'invenzione di una macchina del tempo, un gruppo di assassini viene ingaggiato per uccidere vittime nel passato. Uno di loro, però, un giorno, deve affrontare se stesso.', 2012, '00:00:00', './Media/Loop.mp4', './images/film/Loop.jpg'),
(22, 'Sopravvissuto- The Martian', '00:03:43', 'fantascienza', 'L\'equipaggio della Nasa Ares 3 è in missione su Marte, quando una violenta tempesta di sabbia costringe tutti ad abbandonare la base e tornare a casa. Ma l\'astronauta Mark Watney, ingegnere meccanico e botanico, viene colpito in pieno da un detrito e allontanato dalla squadra, che lo ritiene morto.', 2015, '00:00:00', './Media/Sopra.mp4', './images/film/Sopra.jpg'),
(23, 'Thor', '00:02:32', 'fantasy', 'Dopo che le sue azioni sconsiderate hanno riacceso un\'antica guerra, il dio nordico Thor viene spogliato dei propri poteri, scacciato dal regno di Asgard, e costretto a vivere tra gli umani.', 2011, '00:00:00', './Media/Thor.mp4', './images/film/Thor.jpg'),
...
(31, 'Countdown', '00:02:40', 'thriller', 'Una giovane infermiera scarica un\'applicazione che prevede la data di morte delle persone, e scopre di avere solo tre giorni di vita. La donna corre contro il tempo per trovare il modo di salvare la propria vita.', 2019, '00:00:00', './Media/Count', './images/film/Count.jpg'),
(32, 'Breaking Bad', '00:02:07', 'consigliati', 'Walter White è un professore di chimica di Albuquerque, New Mexico, che vive con la moglie Skyler, incinta della loro secondogenita, e il figlio Walter \"Flynn\" Junior, affetto da una paralisi cerebrale che gli causa problemi di linguaggio e lo costringe a camminare con l\'aiuto di stampelle per muoversi.', 2013, '00:00:00', './Media/Break.mp4', './Media/img1.jpg'),
(33, 'Money Heist', '00:01:31', 'consigliati', 'La storia narra gli sviluppi di una rapina estremamente ambiziosa e originale: irrompere nella Fábrica Nacional de Moneda y Timbre, a Madrid, far stampare migliaia di milioni di banconote e scappare con il bottino. L\'ideatore di questa impresa è un uomo conosciuto come \"il Professore\".', 2018, '00:00:00', './Media/Money.mp4', './Media/img2.jpg'),
(34, 'House of Cards', '00:02:29', 'consigliati', 'Battaglie contro Raymond Tusk (Gerald McRaney) cerca di mantenere la sua posizione come braccio destro di Walker, e contro il suo ex direttore della comunicazione, Remy Danton (Mahershala Ali), che è ora un lobbista alle dipendenze di Tusk.', 2013, '00:00:00', './Media/House.mp4', './Media/img3.jpg'),
(35, 'The Witcher', '00:02:10', 'consigliati', 'In un mondo abitato da esseri umani, elfi, nani e altre specie magiche, l\'equilibrio è sempre instabile. Le razze civilizzate devono infatti convivere con i mostri che li minacciano e per questo motivo sono stati creati dei guerrieri mutanti in grado di ucciderli: i witcher.', 2019, '00:00:00', './Media/Witch.mp4', './Media/img4.jpg'),
(36, 'The Walking Dead', '00:02:19', 'consigliati', 'Rick Grimes è un vice sceriffo vittima di un incidente durante uno scontro a fuoco con dei fuorilegge: colpito alla schiena, va in coma, lasciando tra le lacrime la moglie Lori e il figlio Carl. Il risveglio, poco tempo dopo, è traumatico: l\'ospedale è distrutto ed è pieno di cadaveri.', 2013, '00:00:00', './Media/Dead.mp4', './Media/img5.jpg'),
(37, 'Jhon Wick III', '00:02:35', 'consigliati', 'In fuga con una taglia da 14 milioni di dollari sul capo, il celebre sicario John Wick cerca di sopravvivere dopo aver perso la protezione del Sindacato degli Assassini.', 2019, '00:00:00', './Media/Jhon.mp4', './Media/img6.jpg'),
...
(40, 'Black Mirror', '00:02:29', 'consigliati', 'La fiction, ambientata nel futuro, ma in realtà ispirata al mondo di oggi, è incentrata sui problemi di attualità e sulle sfide poste dall\'introduzione di nuove tecnologie.', 2011, '00:00:00', './Media/Black.mp4', './Media/img9.jpg'),
...
('ciarpaglini.lorenzo@gmail.com', 'c7cc6a1fd6d6b5f4817025cb532b52fa', ''),
('domece80@live.it', '6e6bc4e49dd477ebc98ef4046c067b5f', '');
...
--
ALTER TABLE `preferito`
  ADD CONSTRAINT `fk_preferito` FOREIGN KEY (`film_id`) REFERENCES `film` (`ID`);
COMMIT;
